                      ...
                      <form class="form-horizontal" method="post" action="{{ route('admin#insertPizza') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="inputName" placeholder="Price" name="price">
                              @if($errors->has('price'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="inputName" placeholder="Discount" name="discount">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="inputName" placeholder="Waiting Time" name="waitingTime">
