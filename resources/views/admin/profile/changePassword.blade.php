          ...
          <div class="col-8 offset-3 mt-5">
            <div class="col-md-9">
              <div class="card">
                ...
                <div class="card-body">
                    @if (Session::has('notMachError'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        {{ Session::get('notMachError') }}
                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" action="{{ route('admin#changePassword',Auth()->user()->id) }}" method="post">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="password"  name="oldPassword" class="form-control" value="{{ old('oldPassword') }}" id="inputName" placeholder="">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="password" name="newPassword" class="form-control" value="{{ old('newPassword') }}" id="inputEmail" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="password" name="confirmPassword" class="form-control" value="{{ old('confirmPassword') }}" id="inputPhone" placeholder="">
