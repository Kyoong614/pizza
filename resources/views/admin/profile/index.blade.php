                    ...
                    <div class="active tab-pane" id="activity">
                      <form class="form-horizontal" action="{{ route('admin#update',$user->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="integer" name="phone" class="form-control" value="{{ old('phone',$user->phone) }}" id="inputPhone" placeholder="Phone Number">
                              @if($errors ->has('phone'))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="address" value="{{old('address',$user->address)  }}" id="inputAddress" placeholder="Address">
